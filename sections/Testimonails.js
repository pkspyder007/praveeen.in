      ...
      <div className="flex flex-wrap rounded-lg" style={{ maxWidth: "88vw" }}>
        ...
        <div className="lg:w-3/5 xl:w-3/5 bg-gray-200 pl-4 pt-4 pb-4 pr-4 xl:pr-10 xl:pl-0 xl:pt-10 xl:pb-10 xl:rounded-tr xl:rounded-br relative">
          ...
          >
                  ...
                  <div className="relative bg-white">
                    ...
                    <div className="pt-20 px-6 sm:px-12">
                      <p className="text-gray-600 text-base pb-6">
                        ...
                        organizations on their journey to digital
                        transformation. Our customers include 15 million
                        professionals in 175 countries and 800 of the fortune
                        1000.
                      </p>
                      <p className="text-gray-600 text-base pb-8">
              ...
              <Slide index={3}>
                <figure>
                  <div className="relative bg-white">
                    ...
                    <div className="pt-20 px-6 sm:px-12">
                      <p className="text-gray-600 text-base pb-6">
                        It's not just a pretty face but I am also thrilled by
                        the quality of support. It's fast reliable and has no
                        complications at all. It has completely changed the way
                        I develop a website . It lets you create anything you
                        envision and it does so easily and flawlessly.
                      </p>
                      <p className="text-gray-600 text-base pb-8">
                        Undoubtedly working with them was just like playing. It
                        was so easy editing your content, so fast getting
                        perfect results and so easy customizing based on your
                        own brand.Thank you so much.
                      </p>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center pb-12">
                          <div className="h-12 w-12">
            ...
            <div className="absolute z-40 bottom-0 right-0 mr-12 md:mr-24 md:mb-8 mb-4">
